...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.cmd_carousel.setEnabled(False)
        ...
        self.cmd_static = QtWidgets.QCommandLinkButton(self.scrollAreaWidgetContents)
        self.cmd_static.setEnabled(True)
        self.cmd_static.setObjectName("cmd_static")
        self.verticalLayout.addWidget(self.cmd_static)
        ...
        self.app_title.setGeometry(QtCore.QRect(110, 20, 481, 41))
        font = QtGui.QFont()
        ...
        self.app_subtitle.setGeometry(QtCore.QRect(110, 80, 481, 21))
        font = QtGui.QFont()
        font.setPointSize(9)
        font.setItalic(True)
        ...
        self.label.setGeometry(QtCore.QRect(390, 20, 201, 41))
        font = QtGui.QFont()
        ...
        self.btn_sync.setGeometry(QtCore.QRect(620, 20, 201, 31))
        ...
        self.btn_push.setGeometry(QtCore.QRect(620, 50, 201, 31))
        self.btn_push.setObjectName("btn_push")
        self.app_subtitle_2 = QtWidgets.QLabel(self.centralwidget)
        self.app_subtitle_2.setGeometry(QtCore.QRect(110, 60, 481, 21))
        font = QtGui.QFont()
        ...
        self.label_logo.setGeometry(QtCore.QRect(10, 10, 81, 101))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.cmd_static.setText(_translate("MainWindow", "Konten Profil Gereja"))
        ...
        self.label.setText(_translate("MainWindow", "v0.3.4"))
