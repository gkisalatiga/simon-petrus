...
class FrameGallery(QtWidgets.QFrame, frame_gallery.Ui_Frame):
    ...
    def __init__(self, *args, obj=None, **kwargs):
        ...
        self.gallery_dict = copy.deepcopy(app_assets.gallery)
    ...
    def on_btn_fetch_clicked(self):
        ...
        t = ThreadWithResult(target=app_assets.get_gdrive_folder_list, args=(folder_id,))
        t.start()
        while True:
            if getattr(t, 'result', None):
                # Obtaining the thread function's result
    ...
    def on_btn_save_clicked(self):
        # Overwrite the existing forms object.
        app_assets.gallery = copy.deepcopy(self.gallery_dict)

        # Save to local file.
        app_assets.save_local_gallery()
